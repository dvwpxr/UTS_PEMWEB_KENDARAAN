    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.kendaraans.update", [$kendaraan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $kendaraan->name) }}">
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $kendaraan->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', $kendaraan->price) }}" step="0.01">
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mesin') ? 'is-invalid' : '' }}" type="text" name="mesin" id="mesin" value="{{ old('mesin', $kendaraan->mesin) }}" step="0.01">
                @if($errors->has('mesin'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mesin') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fitur') ? 'is-invalid' : '' }}" type="text" name="fitur" id="fitur" value="{{ old('fitur', $kendaraan->fitur) }}" step="0.01">
                @if($errors->has('fitur'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fitur') }}
                    </div>
